...
/**
 * 修改自jfinal的FileRender,修改后使能添加指定的文件名进行render
 */
public class JfsnpmFileRender extends Render {
	
	private static final String DEFAULT_CONTENT_TYPE = "application/octet-stream";
	
	private File file;
	private String fileRenderName;
	
	public JfsnpmFileRender(File file,String fileRenderName) {
		this.file = file;
		this.fileRenderName = fileRenderName;
	}
	...
	public void render() {
		...
		response.setHeader("Content-disposition", "attachment; filename=" + encodeFileName(fileRenderName));
