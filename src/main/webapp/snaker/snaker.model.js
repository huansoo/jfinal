...
$.extend(true,snakerflow.config.props.props,{
	...
	instanceUrl : {name:'instanceUrl', label:'流程表单', value:'', editor:function(){return new snakerflow.editors.inputEditor();}},
...
$.extend(true,snakerflow.config.tools.states,{
			...
			task : {
				...
				props : {
					...
					form: {name:'form', label : '任务表单', value:'', editor: function(){return new snakerflow.editors.inputEditor();}},
