...
+function ($) {
    ...
    var BJUI = {
        ...
        initLayout: function(ww) {
            ...
            /*$('#bjui-navtab .tabsPageContent').height(iContentH - navtabH)原方法*/
...
+function ($) {
    ...
    window.FRAG = {
        ...
        gridFilter: '<div class="datagrid-filter-box">'
                  ...
                  //+ '<span class="filter-b"></span>'//by 天为之殇 设置为单列单条件查询
                  ...
                  + '<span class="filter-ok"><button type="button" class="btn-green ok" data-icon="check">#filter#</button></span>'
                  + '</fieldset>'
                  + '</div>'
        ,
...
+function ($) {
    ...
    Dialog.prototype.reload = function(option) {
        ...
        if ($dialog && $dialog.length) {
            ...
            op.url = options.url // add by 天为之殇 
            var _reload = function() {
                var $dialogContent = $dialog.find('> .dialogContent')
...
+function ($) {
    ...
    Datagrid.prototype.refresh = function() {
        ...
        if (!options.postData || !options.postData[pageInfo.pageSize]) {
            ...
            //postData[pageInfo.pageCurrent] = paging.pageCurrent//by 天为之殇 刷新不带页码数据
        }
        ...
        if (KindEditor) {
            $box.find('[data-toggle="kindeditor"]').each(function() {
                ...
                KindEditor.create($editor, {
                    ...
                    readonlyMode			 : options.readonlyMode || false,//add by 天为之殇 for 支持只读初始化
